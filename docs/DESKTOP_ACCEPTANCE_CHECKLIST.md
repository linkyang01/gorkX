...
**当前公开版本（2026-08-31）**：gorkX `1.3.1`；包内内核 `grok 1.0.12 (bc7f02eddd3d)`，含补丁 0001–0007。本轮按 Apple Silicon `arm64_adhoc` 范围发布；下方真实人工验收记录中的旧版本仍是历史证据。
**发布边界**：本轮不宣称 Developer ID/公证、干净机安装重开或原生 Intel 验收；这些范围仍由发布门禁单独记录。
