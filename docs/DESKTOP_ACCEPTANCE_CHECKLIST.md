...
**2026-08-09 GUI 复核结果**：B1 真实首轮、账户/额度、模型列表、外观深色、`+` 桌面动作、委派引导面板、退出重开恢复已通过；委派启动、麦克风、干净机和第三方 endpoint 仍按下方门槛保留为未验收。详见 [`VALIDATION_EVIDENCE.md`](VALIDATION_EVIDENCE.md)。
