...
| Chat | Rewind conversation | **Not yet surfaced** — locked Grok Build exposes `x.ai/rewind/*`, but gorkX still needs a checkpoint picker and conflict-safe confirmation before it can honestly offer this destructive operation. |
