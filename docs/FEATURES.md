...
- **Hooks:** the product settings intentionally do not expose Hook controls until the current bundled kernel has a renewed real-project acceptance run. Project `AGENTS.md` instructions remain available as a separate local capability.
