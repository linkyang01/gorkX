...
- **Hook authoring:** gorkX can safely inspect and control Hooks the kernel already discovers, but it does not yet provide a free-form Hook authoring editor. Hook files remain project- or plugin-owned configuration; commands and URLs are intentionally not echoed in the desktop UI.
