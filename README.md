...
**当前版本：0.4.1** · **许可：Apache-2.0** · **首选平台：macOS Apple Silicon**
...
| 平台 | 安装包 |
|------|--------|
| **macOS Apple Silicon** | [gorkX_0.4.1_aarch64.dmg](https://github.com/linkyang01/gorkX/releases/download/v0.4.1/gorkX_0.4.1_aarch64.dmg) |
...
**Version 0.4.1** · **Apache-2.0** · **macOS Apple Silicon first**
