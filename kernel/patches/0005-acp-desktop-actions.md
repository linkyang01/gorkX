...
This patch does not add a second agent loop or duplicate workflow state. It is applied to the locked Grok Build `1.0.0` source at the revision recorded in `kernel/grok-build.lock.toml`.
