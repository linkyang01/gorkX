...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            workspace::workspace_create_hook_verification_project,
            workspace::workspace_read_hook_verification_marker,
            workspace::workspace_remove_hook_verification_project,
            ...
            extensions::extensions_marketplace_add,
            extensions::extensions_marketplace_update,
            extensions::extensions_marketplace_remove,
